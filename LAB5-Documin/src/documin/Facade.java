...
public class Facade {
	...
	public boolean criarDocumento(String titulo) {
		this.documento.criarDocumento(titulo);
	}
	
	public int criarTexto(String tituloDoc, String valor, int prioridade) {
		elemento.criarTexto(valor, prioridade);
	}
	
	public int criarTitulo(String tituloDoc, String valor, int prioridade, int nivel, boolean linkavel) {
		this.documento.criarTitulo(tituloDoc, valor, prioridade, nivel, linkavel);
	}
	
	public int criarLista(String tituloDoc, String valorLista, int prioridade, String separador, String charLista) {
		this.documento.criarLista(tituloDoc, valorLista, prioridade, separador, charLista);
	}
